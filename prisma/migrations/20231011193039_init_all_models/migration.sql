...
*/
-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('CLIENT', 'PHOTOGRAPHER', 'ADMIN', 'SUPER_ADMIN');

-- CreateEnum
CREATE TYPE "BookingStatus" AS ENUM ('PENDING', 'ACCEPTED', 'REJECTED', 'ADJUSTED', 'COMPLETED', 'CANCELED');
